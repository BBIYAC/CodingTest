...
add, sub, multi, division = map(int, input().split())
operations = set(permutations(''.join(['+'*add, '-'*sub,'*'*multi,'%'*division]), n-1))
# 결과 리스트
a_sum = []
